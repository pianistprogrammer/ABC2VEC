#!/bin/bash
# Ablation Model 1: MMM Only
# Tests the contribution of Masked Music Modeling alone
...
echo "=============================================="
echo "Training Ablation Model 1/6: MMM Only"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "✓ MMM Only training complete!"
echo "=============================================="
