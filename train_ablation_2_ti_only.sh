#!/bin/bash
# Ablation Model 2: TI Only
# Tests the contribution of Transposition Invariance alone
...
echo "=============================================="
echo "Training Ablation Model 2/6: TI Only"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "✓ TI Only training complete!"
echo "=============================================="
