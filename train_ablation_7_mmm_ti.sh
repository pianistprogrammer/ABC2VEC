#!/bin/bash
# Ablation Model 6: SCL Only
# Tests the contribution of Section Contrastive Learning alone

set -e

DATA_DIR="./data/processed"
OUTPUT_DIR="./checkpoints/ablation/mmm_ti"
EPOCHS=40
BATCH_SIZE=32
GRAD_ACCUM=4
LR=1e-4
...
echo "=============================================="
echo "Training Ablation Model 7/7: MMM+TI"
echo "=============================================="
