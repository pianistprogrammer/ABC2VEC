...
Evaluates mode classification using logistic regression on frozen embeddings.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate mode classification")
    parser.add_argument(
        "--checkpoint",
        type=str,
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="./checkpoints/mode_classification_results.json",
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="+",
        default=["major", "minor", "dorian", "mixolydian"],
        help="Modes to include in classification",
    )
    args = parser.parse_args()

    print("=" * 80)
    print("ABC2Vec Mode Classification Evaluation")
    print("=" * 80)
    print()
    print("Configuration:")
